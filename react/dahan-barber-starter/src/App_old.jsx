    ...
    <footer id="contact">
      <div className="container footer">
        ...
        <div style={{display:"flex",gap:10,justifyContent:"flex-end",flexWrap:"wrap"}}>
          <a className="btn ghost" href="tel:+972500000000">📞 התקשרו</a>
          <a className="btn ghost" href="https://wa.me/972500000000" target="_blank" rel="noreferrer">💬 וואטסאפ</a>
          <a className="btn primary" href="/booking">קבע תור</a>
        </div>
      </div>
    </footer>
  );
